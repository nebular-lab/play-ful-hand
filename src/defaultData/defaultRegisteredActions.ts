...
export const defaultRegisteredActions: RegisteredActionType[] = [
  ...
  { action: { move: 'PREFLOP', size: 0 }, id: 2, color: 'yellow.700' },
  { action: { move: 'BET', size: 30 }, id: 3, color: 'orange.300' },
  { action: { move: 'BET', size: 70 }, id: 4, color: 'red.300' },
  { action: { move: 'BET', size: 120 }, id: 5, color: 'purple.300' },
